...
// Signup form — registers new business account and logs in
...
export default function SignupPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    // Basic validation
    if (!form.name || !form.email || !form.password || !form.whatsapp_number) {
      ...
      <div className="w-full max-w-md animate-fade-in">
        ...
        <div className="bg-white rounded-3xl shadow-modal border border-slate-100 overflow-hidden">
          ...
          <div className="px-8 py-10">
            ...
            <p className="text-sm text-slate-500 text-center mb-6">Start automating your COD confirmations</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 rounded-xl border border-slate-200 text-sm text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition"
                />
              </div>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-2.5 bg-blue-600 hover:bg-blue-700 disabled:bg-blue-400 text-white font-semibold rounded-xl text-sm transition-all duration-150 active:scale-[0.98] flex items-center justify-center gap-2 mt-4"
              >
                {loading ? (
                  <>
